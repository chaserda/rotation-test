...
from rotation_counter.vlm import classify_all, close_open_lap

load_dotenv()


def analyze(video_path: str, provider_name: str) -> int:
    ...
    labels = classify_all(frames, provider, model)
...
def main() -> None:
    ...
    result = analyze(args.video, args.provider)
